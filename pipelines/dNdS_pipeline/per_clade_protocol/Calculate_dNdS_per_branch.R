...
# data_sequence$sum_den_dN = data_sequence$den_dN_S..S +data_sequence$den_dN_S..W +data_sequence$den_dN_W..S +data_sequence$den_dN_W..W
# data_sequence$sum_num_dN = data_sequence$num_dN_S..S +data_sequence$num_dN_S..W +data_sequence$num_dN_W..S +data_sequence$num_dN_W..W
# data_sequence$sum_den_dS = data_sequence$den_dS_S..S +data_sequence$den_dS_S..W +data_sequence$den_dS_W..S +data_sequence$den_dS_W..W
# data_sequence$sum_num_dS = data_sequence$num_dS_S..S +data_sequence$num_dS_S..W +data_sequence$num_dS_W..S +data_sequence$num_dS_W..W
