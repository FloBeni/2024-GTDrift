...
list_species = gene_No_aas_cds$species[gene_No_aas_cds$nb_gene_85 > (.8 * length(all.files))] ### WARNING 30percent pour article
...
for (file in names(list_genes_RAXML)[1:(length(list_genes_RAXML) * 0.2)] ){
