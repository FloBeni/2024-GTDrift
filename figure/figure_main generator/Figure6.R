...
jpeg(paste(path_pannel,"F6pC.jpg",sep=""),width = 6800/resolution, height = 4000/resolution,res=700/resolution)
print(pC)
dev.off()
...
imgC = load.image(paste(path_pannel,"F6pC.jpg",sep=""))


{
  pdf(file= paste(path_figure,"Figure6.pdf",sep=""), width=4*5/2, height=2.75*3*1.33)
