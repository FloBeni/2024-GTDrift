...
jpeg(paste(path_pannel,"F7p1.jpg",sep=""),width = 8500/resolution, height = 4000/resolution,res=700/resolution)
print(pA)
dev.off()
...
imgA = load.image(paste(path_pannel,"F7p1.jpg",sep=""))


{
  pdf(file= paste(path_figure,"Figure7.pdf",sep=""), width=6*5/2, height=2.75*3)
