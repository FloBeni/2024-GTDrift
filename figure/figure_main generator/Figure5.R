...
jpeg(paste(path_pannel,"F5pB.jpg",sep=""),width = 6800/resolution, height = 4000/resolution,res=700/resolution)
print(pB)
dev.off()
...
{
  pdf(file= paste(path_figure,"Figure5.pdf",sep=""), width=4*5/2, height=2.75*3)
